  ...
  return (
    <section className="py-24 md:py-32 bg-brand-black text-brand-white">
      <div className="container mx-auto px-6 md:px-12">
        <div className="mb-20">
          <h2 className="text-sm font-semibold tracking-widest uppercase text-brand-accent mb-4">Selected Work</h2>
              ...
              <Link href={`/work/${project.id}`} className="block">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  ...
                  <div className="lg:col-span-4 flex flex-col justify-center">
                    ...
                    <p className="text-brand-gray text-sm tracking-wide uppercase mb-8">
                      {project.category}
                    </p>
